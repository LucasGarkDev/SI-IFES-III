...
import controller.TableModelCliente;
...
public class DlgPesqCliente extends javax.swing.JDialog {
    ...
    private GenericTableModel<Cliente> tblModelCliente;
    ...
    public DlgPesqCliente(java.awt.Frame parent, boolean modal) {
        ...
        String[] colunas = {"Nome","Bairro","Cidade","Data de Nascimento","Tel. Fix","Foto"};
        String[] atributos = {"nome","enredeco","enredeco","dtNasc","telFixo","foto"}; //Iguais aos campos do objeto
        
        
        // Criar o Table Model Abstratc
        tblModelCliente = new GenericTableModel<>(colunas, atributos);
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        try {
            ...
            List<Cliente> lista = GerInterGrafica.getMyInstance().getGerDominio().pesquisarCliente( pesq, tipo );
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        try {
            ...
            if ( linha >= 0 ) {
                ...
                GerInterGrafica.getMyInstance().getGerDominio().excluirCliente(cli);
            } else {
